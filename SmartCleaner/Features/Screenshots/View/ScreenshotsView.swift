    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            ...
            VStack(spacing: 0) {
                ...
                // MARK: Title + Stats
                CategoryHeaderView(title: "Screenshots", count: viewModel.assets.count, totalSize: viewModel.totalSize, countLabel: "Photos")
